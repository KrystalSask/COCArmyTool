...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    <footer><span>COCArmyTool v0.1.0 · 数据仅存本机</span><span>本内容为非官方内容，未经 Supercell 认可。详见 <a href="https://supercell.com/en/fan-content-policy/" target="_blank" rel="noreferrer">Supercell 粉丝内容政策</a>。</span></footer>
  </div>
}
